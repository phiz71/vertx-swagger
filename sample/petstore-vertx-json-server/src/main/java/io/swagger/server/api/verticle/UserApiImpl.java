...
public class UserApiImpl implements UserApi {
  ...
  @Override
  public void createUsersWithArrayInput(JsonArray body,
      Handler<AsyncResult<ResourceResponse<Void>>> handler) {
    // TODO Auto-generated method stub
  }

  @Override
  public void createUsersWithListInput(JsonArray body,
      Handler<AsyncResult<ResourceResponse<Void>>> handler) {
    // TODO Auto-generated method stub
  }
  ...
  public void updateUser(String username, ModelUser body,
    ...
    @Override
    public void uuid(String uuidParam, Handler<AsyncResult<ResourceResponse<InlineResponseDefault>>> handler) {
